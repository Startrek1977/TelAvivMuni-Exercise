$json = Get-Content "$PSScriptRoot\Products.json" | ConvertFrom-Json
...
[void]$sb.AppendLine('-- CREATE DATABASE TelAvivMuni;')
[void]$sb.AppendLine('-- GO')
[void]$sb.AppendLine('-- USE TelAvivMuni;')
[void]$sb.AppendLine('-- GO')
[void]$sb.AppendLine('')
[void]$sb.AppendLine('-- =============================================')
...
# Write to file
$sb.ToString() | Out-File -FilePath "$PSScriptRoot\CreateProductsDatabase.sql" -Encoding UTF8

Write-Host 'SQL script generated successfully!'
Write-Host ('File: ' + "$PSScriptRoot\CreateProductsDatabase.sql")
